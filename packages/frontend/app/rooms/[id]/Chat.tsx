...
import { ChatMessage } from '@/types/WebSocketMessage';
import { FormEvent, useEffect, useState } from 'react';
import { useRoom, useUser, useWs } from '@/app/context/providers';
import ChatMessageItem from './ChatMessage';

export default function Chat(params: { chatLogs: Array<ChatMessage> }) {
    ...
    return (
        <section className='flex flex-col items-center max-h-[50%]:'>
            ...
            <section className='flex flex-col items-center w-[90%] md:max-w-lg bg-white rounded-lg'>
                <section className='flex flex-col bg-white my-2 py-2 mx-auto w-[90%] max-h-48 max-w-full gap-1 overflow-y-scroll'>
                ...
                <form className='sticky flex flex-row py-2 w-[90%] bg-white gap-4 rounded-md' onSubmit={handleMessageSend}>
